...
var progressfoodBar = document.getElementById("progress-food-bar");
var updatefoodButton = document.getElementById("update-food-button");
var foodProgress = 0; // Set the initial progress value to 0

// Update the progress bar with a new progress value
var updateFoodBar = function updateFoodBar() {
  ...
  var progressBarFill = document.getElementById("progress-food-bar-fill");
...
// Get the progress bar element and the update button
var progressHappinessBar = document.getElementById("progress-happiness-bar");
var updateHappinessButton = document.getElementById("update-happiness-button");
var happinessProgress = 0; // Set the initial progress value to 0

// Update the progress bar with a new progress value
var updateHappinessBar = function updateHappinessBar() {
  // Create a new element to represent the progress bar fill
  progressHappinessBar.innerHTML = "<div id='progress-happiness-bar-fill'></div>";

  // Get the progress bar fill element from the HTML
  var progressBarFill = document.getElementById("progress-happiness-bar-fill");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60102" + '/');
